...
% dir("./deraining_output_data_for_testing")

for idx_set = 1:num_set
    % file_path = strcat('\sfnet\deraining\', datasets{idx_set}, '\');
    file_path = strcat('./deraining_output_data_for_testing/', datasets{idx_set}, '/');
    fprintf("%s - ", datasets{idx_set})
    % gt_path = strcat('\deraining_testset\', datasets{idx_set}, '\target\');
    gt_path = strcat('./deraining_testset/', datasets{idx_set}, '/target/');
